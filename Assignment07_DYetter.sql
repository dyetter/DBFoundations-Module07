...
-- 2017-01-01,Derek Yetter,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_DYetter')
	 Begin 
	  Alter Database [Assignment07DB_DYetter] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_DYetter;
	 End
	Create Database Assignment07DB_DYetter;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_DYetter;
...
Select
P.ProductName,
[InventoryDate]=DateName(MM, I.InventoryDate) + ',' + DateName(yy,
I.InventoryDate),
...
Select Top 100000
	...
	When Inventory Count > [PreviousMonthCount] then 1
	When Inventory Count = [PreviousMonthCount] then 0
	When Inventory Count < [PreviousMonthCount] then -1
	End, 0)
